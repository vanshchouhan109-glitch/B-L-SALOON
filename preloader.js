/**
 * Brown Luxury Pedicure — Grand Opening Preloader
 *
 * Sequence:
  ...
  function buildPreloader() {
    ...
    el.innerHTML = `
      ...
      <div class="pre-half pre-top">
        <div class="pre-brand">
          <span class="pre-brand-main">Brown Luxury</span>
          <span class="pre-brand-sub">Pedicure</span>
        </div>
      </div>
      ...
      <div class="pre-half pre-bottom">
        <div class="pre-brand">
          <span class="pre-brand-main">Brown Luxury</span>
          <span class="pre-brand-sub">Berkel en Rodenrijs</span>
        </div>
      </div>
      ...
      <div class="pre-intro-text" id="pre-intro">
        ...
        <span class="pre-title">Brown <em>Luxury</em></span>
        <span class="pre-tagline">A true paradise for your feet</span>
        <div class="pre-deco">
